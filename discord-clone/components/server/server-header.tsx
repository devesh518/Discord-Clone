  ...
  return (
    <div>
      <DropdownMenu>
        ...
        >
          <button
            className="w-full text-md text-purple-400
                    font-semibold px-3 flex items-center h-12
                    border-neutral-200 
        ...
        <DropdownMenuContent
          className="w-56 text-xs font-medium 
            text-black dark:text-neutral-400 x space-y-[2px]"
        >
          {isModerator && (
            <DropdownMenuItem onClick={()=>onOpen("invite", {server: server})} className="text-indigo-600 
